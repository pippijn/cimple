...
declaration
	...
	| tspec:sue_type_specifier        semi:";"
	  { declaration4 }
	| spec:declaration_specifier                        id:identifier_declarator body:compound_statement
	  { function_declaration }
	| spec:declaration_specifier_nosue attrs:attributes id:identifier_declarator body:compound_statement
	  { function_declaration }
	| spec:type_specifier                               id:identifier_declarator body:compound_statement
	  { function_declaration }
	| spec:type_specifier_nosue        attrs:attributes id:identifier_declarator body:compound_statement
	  { function_declaration }
	;
...
declaration_qualifier_list
	:                        attrs:attributes? str_class:storage_class attrs2:attributes?
...
initialiser
	...
	| lsqbrack:"[" expr:assignment_expression                                        rsqbrack:"]" equals:"=" init:basic_initialiser
	  { array_labelled_initialised }
	| lsqbrack:"[" expr:assignment_expression dots:"..." expr2:assignment_expression rsqbrack:"]"            init:basic_initialiser
	  { array_labelled_initialised }
	;
...
parameter_type_list
	: decls:parameter_declaration[","]+
	  { parameter_type_list }
	| decls:parameter_declaration[","]+ comma:"," ellipsis:"..."
	  { parameter_type_list }
	;
...
parameter_declaration
	...
	| attrs:attributes? tspec:type_specifier declr:abstract_declarator
	  { parameter_declaration }
	| attrs:attributes? tspec:type_specifier declr:identifier_declarator
	  { parameter_declaration }
	| attrs:attributes? tspec:type_specifier declr:parameter_typedef_declarator
	  { parameter_declaration }
	;
